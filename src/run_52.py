...
def run_52(
    ...
    # BIOCHEMISTRY DR
    biochem_drs = list()
    biochem_drs.append(("CRIM", 240-157, "KINASE", 183-145))
    biochem_drs.append(("CRIM", 240-157, "KINASE", 219-145))
    for biochem_dr in biochem_drs:
        prot1, res1, prot2, res2 = biochem_dr
        dr = IMP.pmi.restraints.basic.DistanceRestraint(
            root_hier=s.get_hierarchy(),
            tuple_selection1=(res1, res1, prot1, 0),
            tuple_selection2=(res2, res2, prot2, 0),
