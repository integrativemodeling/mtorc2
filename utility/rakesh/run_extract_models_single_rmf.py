...
HA = AT.get_models_to_extract('analys/selected_models_A_cluster'+str(c)+'_detailed_random1.csv')
HB = AT.get_models_to_extract('analys/selected_models_B_cluster'+str(c)+'_detailed_random1.csv')
