...
if __name__ == "__main__":
    ...
    structures["MTOR"] = (Path("../../34/sample/output_0/pdbs/model.0.pdb"), "A", "orange", "D")
    structures["RICTOR"] = (Path("../../34/sample/output_0/pdbs/model.0.pdb"), "B", "blue", "E")
    structures["MLST8"] = (Path("../../34/sample/output_0/pdbs/model.0.pdb"), "C", "green", "F")
    clones = dict()
    mols = dict()
    for component in ["MTOR", "RICTOR", "MLST8"]:
        print(component)
    ...
    for component in mols.keys():
        # dof.create_flexible_beads(mols[component].get_non_atomic_residues())
    ...
    xls = list()
    xls.append(("intra_mtor_flex.csv", 1, "DSS"))
    xls.append(("intra_rictor_flex.csv", 1, "DSS"))
