...
#     rigid_parts = list()
#     rigid_parts.extend(list(mols["MTOR"]))
#     rigid_parts.extend(list(mols["RICTOR"]))
#     rigid_parts.extend(list(mols["MLST8"]))
#     rigid_parts.extend(list(mols["MSIN1"][:136]))
#     non_rigid_parts.extend(list(mols["MTOR"].get_non_atomic_residues()))
#     non_rigid_parts.extend(list(mols["RICTOR"].get_non_atomic_residues()))
#     non_rigid_parts.extend(list(mols["MLST8"].get_non_atomic_residues()))
#     non_rigid_parts.append(mols["MSIN1"][0])
#     non_rigid_parts.extend(mols["MSIN1"][:132:136])
...
#     )
#
#     crim_rigid_parts = list(mols["MSIN1"][136:278])
#     crim_non_rigid_parts = list(mols["MSIN1"][267:278])
#     dof.create_rigid_body(
#         rigid_parts=crim_rigid_parts,
#         nonrigid_parts=crim_non_rigid_parts,
#         max_trans=1,
#         max_rot=1,
#         nonrigid_max_trans=1
#     )
#
#     rbd_rigid_parts = list(mols["MSIN1"][278:353])
#     dof.create_rigid_body(
#         rigid_parts=rbd_rigid_parts,
#         max_trans=1,
#         max_rot=1
#     )
...
if __name__ == "__main__":
    ...
    pdb_file = Path("../../36/sample/output_0/pdbs/model.0.pdb")
    ...
    r = IMP.pmi.restraints.stereochemistry.ExcludedVolumeSphere(
        included_objects=[mols["RBD"], mols["CRIM"], mols["MSIN1"], mols["RICTOR"], mols["MLST8"], mols["MTOR"]],
        resolution=10
    )
