...
if __name__ == "__main__":
    ...
    crim_pdb_file = Path("/home/matthew/mtorc2/data/pdb/mSIN1.CRIM.pdb")
    rbd_pdb_file = Path("/home/matthew/mtorc2/data/pdb/msin1.rbd_ph_7lc1.pdb")
    ...
    structures["AKT1"] = (akt1_pdb_file, "M", "salmon", "N")
    ...
    r = IMP.pmi.restraints.stereochemistry.ExcludedVolumeSphere(
        included_objects=[mols["RBD"], mols["CRIM"], mols["MSIN1"], mols["RICTOR"], mols["MLST8"], mols["MTOR"], clones["CRIM"], clones["RBD"], clones["RICTOR"]],
        resolution=10
    )
